...
const editTemplate = (item, onSubmit, invalidMake, invalidModel, invalidYear, invalidDes, invalidPrice, invalidImg) => html`
...
export async function eidtPage(ctx) {
    ...
    async function onSubmit(ev) {
        ...
        if (validMake || validModel || validYear || validDesc || validPrice || validImg) {
            return ctx.render(editTemplate(data, onSubmit, validMake, validModel, validYear, validDesc, validPrice, validImg))
        }
