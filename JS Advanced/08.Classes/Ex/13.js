...
describe('PaymentPackage test', () => {
    ...
    it('value', () => {
        ...
        assert.throw(() => { instance.value = 'f' }, 'Value must be a non-negative number')
    ...
    it('toString', () => {
        ...
        assert.equal(instance.toString(), getString('George', 100, 200, false));
        instance.value = 2;
        assert.equal(instance.toString(), getString('George', 2, 200, false));
    })
})